...
python3 manage.py graph_models twitter | dot -Tpdf > models_twitter.pdf
python3 manage.py graph_models twitter parliament | dot -Tpdf > models_twitter_parliament.pdf
